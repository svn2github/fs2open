...
/*
    $Id: iniparser.c,v 1.1 2005/03/10 19:03:45 randomtiger Exp $
    $Author: randomtiger $
    $Date: 2005/03/10 19:03:45 $
    $Revision: 1.1 $
*/
...
int iniparser_setstr(dictionary * ini, char * entry, char * val)
{
    ...
    if (p) {
        *p = '\0';
        ...
        if ( !iniparser_find_entry(ini, sec) ) {
            iniparser_add_entry(ini, sec, NULL, NULL);
        }
    }

    iniparser_add_entry(ini, sec, key, val);
