...
void debris_page_in()
{
	...
	for (i=0; i<Species_info.size(); i++ )
	{
		...
		nprintf(( "Paging", "Paging in debris texture '%s'\n", species->debris_texture_name));

		if ( strlen(species->species_name) && (species->debris_texture.textures[0].GetTexture() < 0) ) {
