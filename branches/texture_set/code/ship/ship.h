...
public:
	...
	texture_map *ship_replacement_textures;
...
extern texture_map	*Player_cockpit_textures;
...
extern void ship_init_texture_set(ship_info *sip, polymodel *pm);
...
void ship_page_in_textures(ship_info *sip);
